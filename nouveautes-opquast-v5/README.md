...
Site statique GitHub Pages pour les slides accessibles « Nouveautés d’Opquast V5 ».
...
Le script lit `slides.json` et génère `index.html`, `alternatives.html`, `accessibilite.html`, `alternatives.md` et `assets/downloads/nouveautes-opquast-v5-slides.zip`. Chaque slide dispose d’une transcription descriptive et d’un discours oral distincts.
