# Alternatives textuelles - Nouveautés d’Opquast V5

Jeu de slides généré - nouveautes-opquast-v5

## Slide 1 - Opquast V4 → V5 : qu’est-ce qui change ?

### Alternative textuelle

De V4 à V5 : 240 règles, deux retraits, une fusion, huit ajouts, 245 règles.
...
Les huit règles rangées en cinq familles, du contenu à la sécurité.
...
Le mot Bonus en mise en forme native, puis simulé par d’autres caractères.
...
Compte existant ou non, la demande de récupération donne la même réponse.
...
Fiche produit fictive affichant la provenance : fabrication au Portugal.
...
Parcours en trois étapes : demander le code, constater son expiration, relancer.
...
Un champ e-mail relié à l’attribut autocomplete="email" dans le code.
...
Bouton Envoyer grisé, signalé indisponible, avec l’explication affichée.
...
Barre d’adresse visible au-dessus d’un formulaire de connexion.
...
Un courriel passe par SPF, DKIM et DMARC avant la boîte de réception.
...
Deux anciennes règles de la version 4 sorties du référentiel V5.
...
Deux exigences de la version 4 sur les tableaux regroupées dans la règle 245.
...
Le contact du support reformulé entre la version 4 et la règle 112.
...
Un même numéro, 235, désigne deux exigences différentes selon la version.
...
Du site web à l’intranet, aux applications et à la TV connectée.
...
Les tags passent de trois familles de métier à trois familles de nature.
...
Quatre opérations, ajouter, retirer, fusionner, reformuler, mènent de 240 à 245.
