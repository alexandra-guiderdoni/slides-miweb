# publier-de-facon-accessible-sur-les-reseaux-sociaux

Site statique GitHub Pages pour les slides accessibles « Publier accessible sur les réseaux sociaux ».
...
Le script lit `slides.json` et génère `index.html`, `alternatives.html`, `accessibilite.html`, `alternatives.md` et `assets/downloads/publier-de-facon-accessible-sur-les-reseaux-sociaux-slides.zip`.
...
- `source/storyboard-original.md` : source conservée pour traçabilité.
