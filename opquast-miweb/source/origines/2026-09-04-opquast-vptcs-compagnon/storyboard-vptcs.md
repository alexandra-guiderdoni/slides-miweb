...
Source de vérité : `/Users/alex/Claude/projets-actifs/opquast/training/VTPCS.md`.

Le nom du fichier source est `VTPCS.md`, mais le sigle affiché dans le corpus est `VPTCS`. Le deck utilise donc `VPTCS` à l’écran.
...
1. Situer l’expérience dans le temps.
2. Décomposer les attentes de l’utilisateur.
3. Comprendre le modèle et son utilité.
4. Relier le modèle aux métiers et aux décisions.
5. Reconstituer l’expérience unifiée.
6. Ouvrir vers la transversalité, les services physiques et l’avenir.
...
- Transformation : cinq angles séparés deviennent une expérience cohérente.
- Texte visible : `VPTCS`, `Visibilité`, `Perception`, `Technique`, `Contenus`, `Services`.
...
- Transformation : la zone d’intérêt de l’utilisateur s’élargit au fil du parcours.
- Texte visible : `Référencement`, `Accueil`, `Navigation`, `Validation`, `Commerce`, `Logistique`.
...
- Transformation : les verbes d’attente deviennent cinq dimensions nommées.
- Texte visible : `V`, `P`, `T`, `C`, `S`, `Visibilité`, `Perception`, `Technique`, `Contenus`, `Services`.
...
- Transformation : la carte devient utilisable sans prétendre être le territoire.
- Texte visible : `Représentation`, `Exact`, `Simplifié`, `Partiel`, `Réalité`, `Unique`.
...
- Transformation : l’utilisateur passe de la possibilité d’agir à l’envie de revenir.
- Texte visible : `Pré-requis`, `Exigences`, `Plaisir`, `Émotions`.
...
- Transformation : une exigence utilisateur devient une responsabilité identifiable.
- Texte visible : `SEO`, `Design`, `Sécurité`, `Rédaction`, `Relation client`.
- Labels secondaires : `Référencement`, `Ergonomie`, `Hébergement`, `Traduction`, `E-commerce`.
...
- Transformation : l’objet produit devient une valeur comprise et utilisée.
- Texte visible : `Contenus`, `Services`, `Mettre en valeur ?`, `Pourquoi utiliser ?`.
...
- Transformation : le projet passe d’une relation fournisseur à une responsabilité partagée.
- Texte visible : `Prestataires`, `Clients`, `Agences`, `ESN`, `DSI`, `Métiers`.
...
- Transformation : une compétence spécialisée devient une capacité plus transversale.
- Texte visible : `Agences`, `ESN / SSII`, `Compétences`, `VPTCS`.
...
- Transformation : la frontière organisationnelle devient visible comme une rupture potentielle.
- Texte visible : `Prestataires`, `Clients`, `V`, `P`, `T`, `C`, `S`.
...
- Transformation : le modèle devient une hypothèse à observer, transmettre et réviser.
- Texte visible : `Avenir du modèle`, `Exigences utilisateurs`, `Durables ?`, `Merci !`.
- Callout : `Les exigences utilisateurs sont-elles durables ?`
- Risque : conclure par une affirmation non démontrée.
