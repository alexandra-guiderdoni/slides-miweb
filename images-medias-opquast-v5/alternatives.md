# Alternatives textuelles - Images et médias selon Opquast V5
...
Accès, sobriété et contrôle autour d’une interface web.
...
Situation, risque, principe, règle, puis mise en œuvre.
...
Une même image peut être décorative, lien ou porteuse d’information.
...
Tableau : rôle de l’image, question à poser et information à restituer.
...
Graphique d’évolution accompagné d’un tableau des valeurs illustratives.
...
Grande image affichée en vignette, comparée à une vignette adaptée.
...
Objet inclus avec des solutions de repli : HTML, texte, transcription et lien.
...
Vidéo avec transcription, sous-titres synchronisés et durée.
...
Transcription indépendante et sous-titres synchronisés à la vidéo.
...
Commandes pour lancer et contrôler vidéo, son et animation.
...
Un parcours donne accès au contenu sans attendre la fin de l’animation.
...
Règles connexes : graphiques, liens, téléchargements, présentation et PDF.
...
Cas pratiques : image décorative, vidéo, graphique, son, lecture automatique.
...
12 règles organisées autour de l’accès, de la sobriété et du contrôle.
...
Information accessible, ressources utiles et contrôle laissé à l’utilisateur.
